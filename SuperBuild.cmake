...
#-----------------------------------------------------------------------------
set(${LOCAL_PROJECT_NAME}_USE_QT FALSE)
...
option(USE_SYSTEM_statismo "Build using an externally defined version of statismo" OFF)
option(BUILD_SHARED_LIBS "Build shared libraries" OFF)


#-----------------------------------------------------------------------------
# Include External Statismo
#-----------------------------------------------------------------------------
# Statismo
if( ${LOCAL_PROJECT_NAME}_SUPERBUILD MATCHES "ON" )
  include( ${CMAKE_CURRENT_SOURCE_DIR}/SuperBuild/External_statismo.cmake )
endif()
...
set(${LOCAL_PROJECT_NAME}_DEPENDENCIES statismo )
